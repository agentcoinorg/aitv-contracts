...
/// @title Upgradable Base Hook
/// @notice abstract contract for upgradable hook implementations
abstract contract BaseHookUpgradeable is IHooks, IImmutableState {
    ...
    modifier onlyPoolManager() virtual {
        if (msg.sender != address(_getPoolManager())) revert NotPoolManager();
        _;
    }
